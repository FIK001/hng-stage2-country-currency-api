...
from src.image_generator import generate_summary_image  # optional helper for image generation
...
country_model = api.model("Country", {
    ...
    "estimated_gdp": fields.Float(description="Estimated GDP (calculated)"),
...
class AllCountries(Resource):
    ...
    def get(self):
        ...
        sort = request.args.get("sort")  # e.g. gdp_desc or gdp_asc
...
class RefreshCountries(Resource):
    def post(self):
        ...
        try:
            ...
            # Optional summary image generation
            try:
...
if __name__ == "__main__":
    create_tables()
    # Optional: uncomment to auto-refresh on startup
    # refresh_countries()
